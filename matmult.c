...
int main (int argc, char *argv[]) 
{
  ...
  //ADICIONAR MARCADORES DE TEMPO timestamp() IGUAL AO EP01 E PRINTAR NA TELA (M,N,TEMPO) PARA O PLOT.GP CRIAR O GRAFICO DE TEMPO
  //ADICIONAR MARCADORES LIKWID E AS FUNCOES OTIMIZADAS SEPARADAMENTE DAS ORINGINAIS

  double timeMatVet, timeMatMat;
  ...
  printf("%d, %f, %f", n, timeMatVet, timeMatMat);
